...
namespace Infrastructure.Persistence.Migrations
{
	...
	[Migration("20260729161929_AddVolunteerOpportunityFilterIndexes")]
	partial class AddVolunteerOpportunityFilterIndexes
	{
		/// <inheritdoc />
					...
					b.OwnsOne("Domain.Common.Address", "Address", b1 =>
						{
							...
							b1.Property<string>("CityNormalized")
								.ValueGeneratedOnAddOrUpdate()
								.HasColumnType("text")
								.HasColumnName("address_city_normalized")
								.HasComputedColumnSql("lower(address_city)", true);
							...
							b1.HasIndex("CityNormalized")
								.HasDatabaseName("ix_volunteer_opportunity_city_normalized_trgm");

							NpgsqlIndexBuilderExtensions.HasMethod(b1.HasIndex("CityNormalized"), "gin");
							NpgsqlIndexBuilderExtensions.HasOperators(b1.HasIndex("CityNormalized"), new[] { "gin_trgm_ops" });
