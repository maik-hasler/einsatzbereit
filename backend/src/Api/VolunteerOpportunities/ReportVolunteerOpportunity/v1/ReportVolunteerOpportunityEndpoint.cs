...
internal sealed class ReportVolunteerOpportunityEndpoint
	: IEndpoint
{
	public void MapEndpoint(IEndpointRouteBuilder app) =>
		app.MapPost("/volunteer-opportunities/{opportunityId:guid}/reports", ReportVolunteerOpportunityAsync)
			.WithName("ReportVolunteerOpportunity")
	...
	private static async Task<IResult> ReportVolunteerOpportunityAsync(
		[FromRoute] Guid opportunityId,
		[FromBody] ReportVolunteerOpportunityRequest request,
		...
		CancellationToken cancellationToken)
	{
		...
		var command = new ReportVolunteerOpportunityCommand(opportunityId, userId, reason, request.Details);
