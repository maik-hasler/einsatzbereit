...
#pragma warning restore CS8618
	...
	/// <summary>
	/// Capacity-only edit used by the "this and following"/"entire series" bulk
	/// scopes (einsatzbereit#1058), which deliberately don't let a single
	/// capacity change reschedule other occurrences in the series.
	/// </summary>
