...
- [The root scripts/ folder and root package.json were removed](scripts-folder-removed.md) - 98 tracked .mjs/.sh files and the Playwright pin they depended on are gone; live-verification scripts are now scratch-only and never committed.
