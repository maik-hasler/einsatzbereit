...
`CLAUDE.md`/`AGENTS.md` convention files. 19 concept pages, grouped below; each
...
- [Decisions](decisions/index.md) (2) - Why the repo's tooling and autonomous routines are set up the way they are.
