...
description: A moderated role-card testing session with human guests before 1.0 - the human counterpart to field-review's automated personas lens.
...
This event is the human counterpart to `field-review`'s personas lens,
which drives the same kinds of personas (Organizer Olaf, Volunteer Vera, and
- since 2026-07-22 - Platform Admin, matching the role card below) against
...
"someone unfamiliar with technology" card is worth pairing with
`field-review`'s accessibility lens, which goes past what ESLint's jsx-a11y
ruleset can catch.
...
# Related
- [field-review-routine](/decisions/field-review-routine.md) - the personas lens automates, against the same personas, what this event does with human guests
