...
Custom Keycloak 26.6.2 image with the `einsatzbereit` realm pre-baked. Built and published to GHCR via `.github/workflows/keycloak.yml`.
...
1. **Builder stage**: `quay.io/keycloak/keycloak:26.6.2` - runs `kc.sh build` with PostgreSQL provider
