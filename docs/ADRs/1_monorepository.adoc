...
All components (`backend/`, `frontend/`, `keycloak/`, `docs/`) together with shared CI, tooling, and documentation live in the single repository. See the root `AGENTS.md` for the authoritative, current layout.
