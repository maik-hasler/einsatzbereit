...
export default function MyEngagementsPage() {
	...
	const confirmed = engagements.filter((e) => e.status === "Confirmed").length;
	const pending = engagements.filter((e) => e.status === "Pending").length;

	return (
		<>
			<PageHero
				title={t("myEngagements.title")}
				icon={
					...
					<div className="flex flex-wrap gap-3">
						...
						{confirmed > 0 && (
							<div className="flex items-center gap-2 rounded-xl border border-white/20 bg-white/10 px-4 py-2">
								...
								<span className="text-xs text-brand-100">
									{t("myEngagements.status.Confirmed")}
								</span>
							</div>
						)}
						{pending > 0 && (
							<div className="flex items-center gap-2 rounded-xl border border-white/20 bg-white/10 px-4 py-2">
								...
								<span className="text-xs text-brand-100">
									{t("myEngagements.status.Pending")}
								</span>
							</div>
						)}
					</div>
