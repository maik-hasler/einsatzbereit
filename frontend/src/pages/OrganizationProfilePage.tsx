					...
					{profile.contactEmail && (
						<div className="flex items-center gap-3">
							...
							<a
								...
								className="text-brand-700 hover:text-brand-800 hover:underline transition-colors"
							>
								{profile.contactEmail}
							</a>
						</div>
			...
			{profile.openOpportunities.length === 0 ? (
				...
				<ul className="space-y-3">
					{profile.openOpportunities.map((opp) => (
						<li
							key={opp.id}
							className="relative rounded-xl border border-gray-100 bg-white p-4 shadow-sm transition-shadow hover:shadow"
						>
							<Link
