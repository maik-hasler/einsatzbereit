		...
		<>
			...
			<section className="mb-8">
				...
				<p className="text-gray-700 leading-relaxed mb-4">
					...
					allgemeiner Natur erfasst (z.&nbsp;B. IP-Adresse,
					Browsertyp, Uhrzeit des Zugriffs). Diese Daten lassen keine
					Rückschlüsse auf Ihre Person zu und werden zur
					Sicherstellung des Betriebs ausgewertet.
				</p>
				<p className="text-gray-700 leading-relaxed">
					Bei der Registrierung und Anmeldung über unseren
					Authentifizierungsdienst (Keycloak) werden die von Ihnen
					eingegebenen Daten (z.&nbsp;B. Name, E-Mail-Adresse)
					gespeichert, um Ihnen die Nutzung der Plattform zu
					ermöglichen.
				</p>
			</section>
			...
			<section className="mb-8">
				...
				<p className="text-gray-700 leading-relaxed">
					...
					nicht statt, es sei denn, dies ist zur Vertragsabwicklung
			...
			<section className="mb-8">
				...
				<p className="text-gray-700 leading-relaxed">
					...
					Authentifizierung (Session-Cookies). Es werden keine
			...
			<section className="mb-8">
				...
				<p className="text-gray-700 leading-relaxed">
					...
					Daten. Wenden Sie sich dazu an die oben genannte
					verantwortliche Stelle.
				</p>
			</section>
		</>
