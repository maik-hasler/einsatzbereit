...
export class EinsatzbereitApi {
     ...
     * @return No Content
     */
    updateNotificationPreferences(body: UpdateNotificationPreferencesRequest, signal?: AbortSignal): Promise<void> {
        let url_ = this.baseUrl + "/v1/users/me/notification-preferences";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processUpdateNotificationPreferences(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 204) {
            return response.text().then((_responseText) => {
     ...
     * @return OK
     */
    getNotificationPreferences(signal?: AbortSignal): Promise<NotificationPreferencesResponse> {
        let url_ = this.baseUrl + "/v1/users/me/notification-preferences";
        url_ = url_.replace(/[?&]$/, "");
    ...
    unsubscribe(userId: string, type: string, token: string, signal?: AbortSignal): Promise<void> {
        ...
        if (type === undefined || type === null)
            throw new globalThis.Error("The parameter 'type' must be defined and cannot be null.");
        else
     ...
     * @return No Content
     */
    resetDashboardLayout(organizationId: string, signal?: AbortSignal): Promise<void> {
        let url_ = this.baseUrl + "/v1/organizations/{organizationId}/dashboard/layout";
        if (organizationId === undefined || organizationId === null)
            throw new globalThis.Error("The parameter 'organizationId' must be defined.");
        url_ = url_.replace("{organizationId}", encodeURIComponent("" + organizationId));
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processResetDashboardLayout(_response);
        });
    }

    protected processResetDashboardLayout(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 204) {
            return response.text().then((_responseText) => {
     ...
     * @return No Content
     */
    resendInvitation(organizationId: string, invitationId: string, signal?: AbortSignal): Promise<void> {
        let url_ = this.baseUrl + "/v1/organizations/{organizationId}/invitations/{invitationId}/resend";
        if (organizationId === undefined || organizationId === null)
            throw new globalThis.Error("The parameter 'organizationId' must be defined.");
        url_ = url_.replace("{organizationId}", encodeURIComponent("" + organizationId));
    ...
    protected processResendInvitation(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 204) {
            return response.text().then((_responseText) => {
     ...
     * @return OK
     */
    getOrganizationEngagements(organizationId: string, pageNumber: number, pageSize: number, status: string | undefined, search: string | undefined, signal?: AbortSignal): Promise<PagedListOfEngagementSummary> {
        let url_ = this.baseUrl + "/v1/organizations/{organizationId}/engagements?";
        if (organizationId === undefined || organizationId === null)
            throw new globalThis.Error("The parameter 'organizationId' must be defined.");
        url_ = url_.replace("{organizationId}", encodeURIComponent("" + organizationId));
        if (pageNumber === undefined || pageNumber === null)
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processGetOrganizationEngagements(_response);
        });
    }

    protected processGetOrganizationEngagements(response: Response): Promise<PagedListOfEngagementSummary> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
    ...
    getVersion(signal?: AbortSignal): Promise<string> {
        let url_ = this.baseUrl + "/v1/meta/version";
        url_ = url_.replace(/[?&]$/, "");
     ...
     * @return OK
     */
    getPageMeta(slug: string, signal?: AbortSignal): Promise<void> {
        let url_ = this.baseUrl + "/v1/meta/pages/{slug}";
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processGetPageMeta(_response);
        });
    }

    protected processGetPageMeta(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
    ...
    undoCheckInEngagement(engagementId: string, signal?: AbortSignal): Promise<EngagementStatusResponse> {
        let url_ = this.baseUrl + "/v1/engagements/{engagementId}/undo-check-in";
        if (engagementId === undefined || engagementId === null)
            throw new globalThis.Error("The parameter 'engagementId' must be defined.");
        url_ = url_.replace("{engagementId}", encodeURIComponent("" + engagementId));
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processUndoCheckInEngagement(_response);
        });
    }

    protected processUndoCheckInEngagement(response: Response): Promise<EngagementStatusResponse> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return OK
     */
    checkInEngagementByCode(opportunityId: string, body: CheckInEngagementByCodeRequest, signal?: AbortSignal): Promise<EngagementStatusResponse> {
        let url_ = this.baseUrl + "/v1/volunteer-opportunities/{opportunityId}/engagements/check-in-by-code";
        if (opportunityId === undefined || opportunityId === null)
            throw new globalThis.Error("The parameter 'opportunityId' must be defined.");
        url_ = url_.replace("{opportunityId}", encodeURIComponent("" + opportunityId));
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processCheckInEngagementByCode(_response);
        });
    }

    protected processCheckInEngagementByCode(response: Response): Promise<EngagementStatusResponse> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     * @return OK
     */
    bulkConfirmEngagements(opportunityId: string, body: BulkConfirmEngagementsRequest | null | undefined, signal?: AbortSignal): Promise<BulkEngagementActionResponse> {
        let url_ = this.baseUrl + "/v1/volunteer-opportunities/{opportunityId}/engagements/bulk-confirm";
        if (opportunityId === undefined || opportunityId === null)
            throw new globalThis.Error("The parameter 'opportunityId' must be defined.");
        url_ = url_.replace("{opportunityId}", encodeURIComponent("" + opportunityId));
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processBulkConfirmEngagements(_response);
        });
    }

    protected processBulkConfirmEngagements(response: Response): Promise<BulkEngagementActionResponse> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
            let result200: any = null;
            result200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver) as BulkEngagementActionResponse;
            return result200;
            });
        } else if (status === 400) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<BulkEngagementActionResponse>(null as any);
    }
     ...
     * @return OK
     */
    bulkCancelEngagements(opportunityId: string, body: BulkCancelEngagementsRequest | null | undefined, signal?: AbortSignal): Promise<BulkEngagementActionResponse> {
        let url_ = this.baseUrl + "/v1/volunteer-opportunities/{opportunityId}/engagements/bulk-cancel";
        if (opportunityId === undefined || opportunityId === null)
            throw new globalThis.Error("The parameter 'opportunityId' must be defined.");
        url_ = url_.replace("{opportunityId}", encodeURIComponent("" + opportunityId));
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processBulkCancelEngagements(_response);
        });
    }

    protected processBulkCancelEngagements(response: Response): Promise<BulkEngagementActionResponse> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
...
export interface BulkCancelEngagementsRequest {
...
export interface BulkConfirmEngagementsRequest {
    engagementIds: string[];

    [key: string]: any;
}

export interface BulkEngagementActionFailureResponse {
    engagementId: string;
    errorCode: string;
    message: string;
...
export interface BulkEngagementActionResponse {
    succeeded: EngagementStatusResponse[];
    failed: BulkEngagementActionFailureResponse[];
...
export interface CheckInEngagementByCodeRequest {
    code: string;
