...
export class EinsatzbereitApi {
     ...
     * @return No Content
     */
    saveSearchAlert(body: SaveSearchAlertRequest, signal?: AbortSignal): Promise<void> {
        let url_ = this.baseUrl + "/v1/users/me/search-alert";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processSaveSearchAlert(_response);
        });
    }

    protected processSaveSearchAlert(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 204) {
            return response.text().then((_responseText) => {
     ...
     * @return OK
     */
    getSearchAlert(signal?: AbortSignal): Promise<SearchAlertResponse> {
        let url_ = this.baseUrl + "/v1/users/me/search-alert";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processGetSearchAlert(_response);
        });
    }

    protected processGetSearchAlert(response: Response): Promise<SearchAlertResponse> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
            let result200: any = null;
            result200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver) as SearchAlertResponse;
            return result200;
            });
        } else if (status === 401) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<SearchAlertResponse>(null as any);
    }

    /**
     * @return No Content
     */
    deleteSearchAlert(signal?: AbortSignal): Promise<void> {
        let url_ = this.baseUrl + "/v1/users/me/search-alert";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processDeleteSearchAlert(_response);
        });
    }

    protected processDeleteSearchAlert(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 204) {
            return response.text().then((_responseText) => {
...
export interface SaveSearchAlertRequest {
