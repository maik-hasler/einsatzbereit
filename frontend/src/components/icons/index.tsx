...
export function ListBulletIcon({ className = "h-3.5 w-3.5" }: IconProps) {
	return (
		<StrokeIcon className={className}>
			<path
				strokeLinecap="round"
...
export function LockClosedIcon({ className = "h-8 w-8" }: IconProps) {
	return (
		<StrokeIcon className={className}>
			<path
				strokeLinecap="round"
...
export function SignalSlashIcon({ className = "h-8 w-8" }: IconProps) {
	return (
		<StrokeIcon className={className}>
			<path
				strokeLinecap="round"
				strokeLinejoin="round"
				d="M3 3l18 18M14.652 9.348a3.75 3.75 0 0 1 0 5.304m2.121-7.425a6.75 6.75 0 0 1 0 9.546m2.121-11.667a9.75 9.75 0 0 1 0 13.788M9.348 14.652a3.75 3.75 0 0 1-1.06-2.122m-1.061 4.243a6.75 6.75 0 0 1-1.625-6.929m-.496 9.05a9.75 9.75 0 0 1-1.79-11.334"
			/>
		</StrokeIcon>
	);
}

export function ExclamationTriangleIcon({ className = "h-8 w-8" }: IconProps) {
	return (
		<StrokeIcon className={className}>
			<path
				strokeLinecap="round"
